...
Phase 2 and the numbered Phase 3.05 increment add structured acquisition and
...
## 12. Phase 2.2–3.05 AKShare adapter
...
four A-share share-capital raw slices, seven A-share ownership-pledge raw views,
...
This foundation plus the Phase 2.2–3.05 structured slices does not include:
