...
## 12. Phase 2.2–2.65 AKShare adapter
...
[AKShare stock-data documentation](https://akshare.akfamily.xyz/data/stock/stock.html)
and [official implementation](https://github.com/akfamily/akshare/blob/main/akshare/stock/stock_info.py)
...
This foundation plus the Phase 2.2–2.65 slices does not include:
