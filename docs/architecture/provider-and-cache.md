...
Phase 2 and the numbered Phase 3.01 increment add structured acquisition and
...
## 12. Phase 2.2–3.01 AKShare adapter
...
four A-share share-capital raw slices, four A-share ownership-pledge raw views,
...
This foundation plus the Phase 2.2–3.01 structured slices does not include:
